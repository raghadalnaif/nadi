...
import { bookFromPortal, cancelMyBooking, changeMyPortalPassword } from "./actions";
      ...
      <header className="bg-white border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-6 h-16 flex items-center gap-3">
          ...
          <div className="mr-auto flex items-center gap-2">
            <Dialog label="كلمة المرور" title="تغيير كلمة المرور" variant="icon" icon={<KeyRound className="w-4 h-4" />}>
              <form action={changeMyPortalPassword} className="space-y-3">
                <Field label="كلمة مرور جديدة (6 أحرف على الأقل)">
                  <Input name="password" type="password" minLength={6} required dir="ltr" className="text-right" />
                </Field>
                <Submit>تغيير</Submit>
              </form>
            </Dialog>
